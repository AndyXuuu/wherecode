# 2026-03-03 K49-T1/T2/T3 Restore Min-Restored Gate Hardening

## Scope
- Add restore-mode min-restored option and mode guards.
- Add restore min-restored gate output and state snapshot fields.
- Add tests and docs.
