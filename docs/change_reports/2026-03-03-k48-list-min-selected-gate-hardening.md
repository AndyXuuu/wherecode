# 2026-03-03 K48-T1/T2/T3 List Min-Selected Gate Hardening

## Scope
- Add list-mode min-selected option and mode guards.
- Add list min-selected gate output and state snapshot fields.
- Add tests and docs.
