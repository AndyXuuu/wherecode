# 2026-03-03 K47-T1/T2/T3 List Empty Gate Hardening

## Scope
- Add list-mode fail-on-empty option and mode guards.
- Add list empty-guard output and state snapshot fields.
- Add tests and docs.
